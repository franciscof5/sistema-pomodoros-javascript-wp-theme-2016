<?php get_header() ?>
	...
	<div id="content">
		...
		<div class="page" id="register-page">
			<h2><script>document.write(txt_register_heading)</script></h2>
			<div class="register_div_box" id="rbox1">
				<h3><script>document.write(txt_register_option1)</script></h3>
				<center><?php /*do_shortcode("[fb_login size='xlarge' login_text='Conectar' logout_text='Logout']"); */?>
			...
			<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
				...
				<h3><script>document.write(txt_register_option2)</script></h3>
				...
				<div class="register-section" id="basic-details-section">
					...
					<label for="signup_username"><script>document.write(txt_register_username)</script></label>
					<?php do_action( 'bp_signup_username_errors' ) ?>
					<input type="text" name="signup_username" id="signup_username" value="<?php bp_signup_username_value() ?>" />

					<label for="signup_email"><script>document.write(txt_register_email)</script></label>
					<?php do_action( 'bp_signup_email_errors' ) ?>
					<input type="text" name="signup_email" id="signup_email" value="<?php bp_signup_email_value() ?>" />

					<label for="signup_password"><script>document.write(txt_register_pass)</script></label>
					<?php do_action( 'bp_signup_password_errors' ) ?>
					<input type="password" name="signup_password" id="signup_password" value="" />

					<label for="signup_password_confirm"><script>document.write(txt_register_pass_confirm)</script></label>
