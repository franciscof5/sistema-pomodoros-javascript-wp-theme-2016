...
//Sound configuration
soundManager.url = 'http://pomodoros.com.br/wp-content/themes/sistema-pomodoros/pomodoro/soundmanager2.swf';
soundManager.onready(function() {
	// Ready to use; soundManager.createSound() etc. can now be called.
	active_sound = soundManager.createSound({id: 'mySound2',url: 'http://pomodoros.com.br/wp-content/themes/sistema-pomodoros/pomodoro/sounds/crank-2.mp3'});
	pomodoro_completed_sound = soundManager.createSound({id:'mySound3',url: 'http://pomodoros.com.br/wp-content/themes/sistema-pomodoros/pomodoro/sounds/telephone-ring-1.mp3'});
	session_reseted_sound = soundManager.createSound({id:'mySound4',url: 'http://pomodoros.com.br/wp-content/themes/sistema-pomodoros/pomodoro/sounds/magic-chime-02.mp3'});
