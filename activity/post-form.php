...
<form action="<?php bp_activity_post_form_action(); ?>" method="post" id="whats-new-form" name="whats-new-form" role="complementary">
	...
	<h5><?php if ( bp_is_group() )
			...
			echo "Qual a sua meta? Porque usar o Pomodoros.com.br vai te ajudar a realiza-la? Compartilhe com ".bp_get_group_name().", ".bp_get_user_firstname()."s?";
		else
			//printf( __( "What's new, %s?", 'buddypress' ), bp_get_user_firstname() );
			echo "Qual a sua meta? Porque usar o Pomodoros.com.br vai te ajudar a realiza-la? Compartilhe com todos, ".bp_get_user_firstname()."s?";
	?></h5>
