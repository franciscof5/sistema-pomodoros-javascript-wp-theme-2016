...
Bellevue_Kirki::add_field( 'bellevue_theme', array(
    ...
    /*
     'partial_refresh' => array(
        'themo_logo_resize' => array(
            'selector'        => '#logo img#logo1',
            'container_inclusive' => true,
            'render_callback' => 'th_logo_reseize',
        ),
    ),
    */
) );
...
Bellevue_Kirki::add_field( 'bellevue_theme', array(
    ...
    'output' => array(
        ...
        array(
            'element'  => '.btn-ghost-accent,.btn-ghost-accent:focus,.elementor-widget-themo-header.elementor-view-framed .th-header-wrap .elementor-icon,.elementor-widget-themo-service-block.elementor-view-framed .th-service-block-w .elementor-icon,.btn-ghost-accent-form form .frm_submit input[type=submit]',
            'property' => 'color',
        ),
        array(
...
Bellevue_Kirki::add_section('plugins', array(
    'title' => esc_attr__('Bundled Plugins', 'bellevue'),
    'priority' => 2,
    'panel' => 'th_options',
    'capability' => 'edit_theme_options',
));
...
Bellevue_Kirki::add_field( 'bellevue_theme', array(
    ...
    'description' => '<div class="th-theme-support dashicons-before dashicons-editor-help">' . sprintf(__(' <a href="%1$s" target="_blank">Documentation</a>', 'bellevue'), 'https://themovation.helpscoutdocs.com/category/225-hotel-booking') . '</div>',
    'section'     => 'plugins',
    'default'     => 'on',
    'priority'    => 10,
    'choices'     => array(
...
Bellevue_Kirki::add_field( 'bellevue_theme', array(
    ...
    'description' => '<div class="th-theme-support dashicons-before dashicons-editor-help">' . sprintf(__(' <a href="%1$s" target="_blank">Documentation</a>', 'bellevue'), 'https://themovation.helpscoutdocs.com/article/303-hotel-booking-woocommerce-payments') . '</div>',
    'section'     => 'plugins',
    'default'     => 'off',
    'priority'    => 10,
    'choices'     => array(
...
// Plugins : Hotel Booking Reviews
Bellevue_Kirki::add_field( 'bellevue_theme', array(
    'type'        => 'switch',
    'settings'    => 'themo_tgmpa_hotel_booking_reviews',
    'label'       => esc_html__( 'Hotel Booking Reviews (beta)', 'bellevue' ),
    'description' => '<div class="th-theme-support dashicons-before dashicons-editor-help">' . sprintf(__(' <a href="%1$s" target="_blank">Documentation</a>', 'bellevue'), 'https://themovation.helpscoutdocs.com/article/304-hotel-booking-reviews-add-on') . '</div>',
    'section'     => 'plugins',
    'default'     => 'off',
    'priority'    => 10,
    'choices'     => array(
...
// Plugins : Hotel Booking Payment Request
Bellevue_Kirki::add_field( 'bellevue_theme', array(
    'type'        => 'switch',
    'settings'    => 'themo_tgmpa_hotel_booking_payment_request',
    'label'       => esc_html__( 'Hotel Booking Payment Request (beta)', 'bellevue' ),
    'description' => '<div class="th-theme-support dashicons-before dashicons-editor-help">' . sprintf(__(' <a href="%1$s" target="_blank">Documentation</a>', 'bellevue'), 'https://themovation.helpscoutdocs.com/article/305-hotel-booking-payment-request-add-on') . '</div>',
    'section'     => 'plugins',
    'default'     => 'off',
    'priority'    => 10,
    'choices'     => array(
...
Bellevue_Kirki::add_field( 'bellevue_theme', array(
    ...
    'label'       => esc_html__( 'Elementor Header & Footer', 'bellevue' ),
    'description' => '<div class="th-theme-support dashicons-before dashicons-editor-help">' . sprintf(__(' <a href="%1$s" target="_blank">Documentation</a>', 'bellevue'), 'https://themovation.helpscoutdocs.com/article/295-adding-a-custom-header-and-footer-in-elementor') . '</div>',
    'section'     => 'plugins',
    'default'     => 'off',
    'priority'    => 10,
    'choices'     => array(
...
Bellevue_Kirki::add_field( 'bellevue_theme', array(
    ...
    'description' => '<div class="th-theme-support dashicons-before dashicons-editor-help">' . sprintf(__(' <a href="%1$s" target="_blank">Documentation</a>', 'bellevue'), 'https://www.themepunch.com/support-center/essential-grid') . '</div>',
    'section'     => 'plugins',
    'default'     => 'off',
    'priority'    => 10,
    'choices'     => array(
...
Bellevue_Kirki::add_field( 'bellevue_theme', array(
    ...
    'description' => '<div class="th-theme-support dashicons-before dashicons-editor-help">' . sprintf(__(' <a href="%1$s" target="_blank">Documentation</a>', 'bellevue'), 'https://grooni.com/docs/groovy-menu/') . '</div>',
    'section'     => 'plugins',
    'default'     => 'off',
    'priority'    => 10,
    'choices'     => array(
...
Bellevue_Kirki::add_field( 'bellevue_theme', array(
    ...
    'description' => '<div class="th-theme-support dashicons-before dashicons-editor-help">' . sprintf(__(' <a href="%1$s" target="_blank">Documentation</a>', 'bellevue'), 'http://docs.averta.net/display/mswpdoc/Master+Slider+WordPress+Documentation') . '</div>',
    'section'     => 'plugins',
    'default'     => 'off',
    'priority'    => 10,
    'choices'     => array(
...
Bellevue_Kirki::add_field( 'bellevue_theme', array(
    ...
    'description' => '<div class="th-theme-support dashicons-before dashicons-editor-help">' . sprintf(__(' <a href="%1$s" target="_blank">Documentation</a>', 'bellevue'), 'https://formidableforms.com/knowledgebase/') . '</div>',
    'section'     => 'plugins',
    'default'     => 'on',
    'priority'    => 10,
    'choices'     => array(
...
Bellevue_Kirki::add_field( 'bellevue_theme', array(
    ...
    'description' => '<div class="th-theme-support dashicons-before dashicons-editor-help">' . sprintf(__(' <a href="%1$s" target="_blank">Documentation</a>', 'bellevue'), 'https://wordpress.org/plugins/widget-logic/') . '</div>',
    'section'     => 'plugins',
    'default'     => 'on',
    'priority'    => 10,
    'choices'     => array(
