			...
			<div class="header-inner section-inner">
				...
				<div class="header-navigation-wrapper">
					...
					<?php } else { ?> 
						<div class="toggle-wrapper nav-toggle-wrapper has-expanded-menu">
							<span class="toggle-inner">
								<a href="<?php echo wp_logout_url('https://www.coworkinghostel.com.br/'); ?>" class="toggle nav-toggle desktop-nav-toggle" aria-expanded="false" data-set-focus=".close-nav-toggle">sair
								</a>
							</span>	
						</div>
					<?php } ?> 
