...
<div class="top-form top-form-minicart  minicart-product-style2 pull-right">
	...
	<h2><?php _e('Shopping Cart','maxshop');?></h2>
		<a class="cart-contents" href="<?php echo wc_get_cart_url(); ?>" title="<?php _e('View your shopping cart', 'maxshop'); ?>"><?php echo '<span class="minicart-number">'.$woocommerce->cart->cart_contents_count.'</span>'; _e('item(s)', 'maxshop');?> - <?php echo $woocommerce->cart->get_cart_total(); ?></a>
    ...
    <div class="product-details"> 
        ...
        <a class="btn-edit" href="<?php echo wc_get_cart_url(); ?>" title="<?php _e('View your shopping cart', 'maxshop'); ?>"><span></span></a>    
