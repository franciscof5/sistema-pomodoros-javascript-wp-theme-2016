...
add_action( 'pt-ocdi/after_import', 'em4u_after_import_setup' );
...
add_filter( 'pt-ocdi/import_files', 'em4u_import_files' );
...
add_action( 'pt-ocdi/after_import', 'em4u_after_import' );