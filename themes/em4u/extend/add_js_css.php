...
function em4u_theme_scripts_styles() {
    ...
    /* Add Javascript  */
    wp_enqueue_script('bootstrap', EM4U_URI.'/assets/plugins/bootstrap-3.3.7-dist/js/bootstrap.min.js', array('jquery'),null,true);
    ...
    /* Add Css  */
    wp_enqueue_style('bootstrap', EM4U_URI.'/assets/plugins/bootstrap-3.3.7-dist/css/bootstrap.min.css', array(), null);
...
function em4u_script_ie() {
    echo '
    <!--[if (gte IE 9)]><!-->
    <!--script src="'.EM4U_URI.'/assets/plugins/iesupport/html5shiv.js"></script>
    <script src="'.EM4U_URI.'/assets/plugins/iesupport/respond.min.js"></script-->
    <!--<![endif]-->
  ';
}
