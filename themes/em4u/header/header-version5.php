...
<!-- Heading Version 1 -->
<header class="ova_header ovatheme_header_v1 ovatheme_header_v5  bg_heading <?php echo esc_attr($header_fixed); ?> <?php echo esc_attr($has_logo_scroll); ?> <?php echo esc_attr($has_logo_mobile); ?>">
