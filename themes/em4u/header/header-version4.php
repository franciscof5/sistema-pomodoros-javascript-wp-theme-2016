...
?>
<!-- Heading Version 4 -->
<header class="ova_header ovatheme_header_v4 bg_heading <?php echo esc_attr($header_fixed); ?> <?php echo esc_attr($has_logo_scroll); ?> <?php echo esc_attr($has_logo_mobile); ?> ">
