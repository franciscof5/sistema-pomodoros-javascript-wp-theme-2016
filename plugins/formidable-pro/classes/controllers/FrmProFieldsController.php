...
class FrmProFieldsController {
	...
	public static function add_currency_field_attributes( $field, &$add_html ) {
		...
		if ( $field['original_type'] === 'total' ) {
			 ...
			 */
			$higher_pg = FrmProFieldsHelper::field_on_page( $field, 'higher' ) ? 'data-frmhigherpg ' : '';
