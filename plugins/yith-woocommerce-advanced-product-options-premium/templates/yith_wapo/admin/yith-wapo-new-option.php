<tr>
    ...
    <td colspan="6">
        ...
        <div class="option-default"><input type="checkbox" name="options[default][]" value="<?php echo isset( $i ) ? $i : ''; ?>" class="new_default" /><?php _e( 'Checked', 'yith-woocommerce-product-add-ons' ) ?></div>
        <div class="option-required"><input type="checkbox" name="options[required][]" value="<?php echo isset( $i ) ? $i : ''; ?>" class="new_required" /><?php _e( 'Required', 'yith-woocommerce-product-add-ons' ) ?></div>
    </td>
</tr>