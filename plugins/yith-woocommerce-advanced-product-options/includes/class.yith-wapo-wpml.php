...
if ( ! class_exists( 'YITH_WAPO_WPML' ) ) {
    ...
    class YITH_WAPO_WPML {
        ...
        public static function register_string( $string , $name ='' ){
            ...
            yit_wpml_register_string( YITH_WAPO_WPML_CONTEXT , '['.YITH_WAPO_SLUG.']'.$name, $string );
        ...
        public static function string_translate( $label ){
            ...
            return yit_wpml_string_translate( YITH_WAPO_WPML_CONTEXT , '['.YITH_WAPO_SLUG.']'.$name, $label );
