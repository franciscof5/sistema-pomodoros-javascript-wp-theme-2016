...
if ( ! class_exists( 'YITH_WCCL_Frontend' ) ) {
	...
	class YITH_WCCL_Frontend {
		...
		public function __construct() {
			...
			// ajax add to cart
			add_action( 'wc_ajax_yith_wccl_add_to_cart', array( $this, 'yith_wccl_add_to_cart_ajax' ) );
		...
		public function enqueue_scripts(){
			...
			wp_register_script( 'yith_wccl_frontend', YITH_WAPO_ASSETS_URL . '/js/yith-wccl'. $suffix .'.js', array( 'jquery', 'wc-add-to-cart-variation' ), $this->version, true );
			...
			wp_localize_script( 'yith_wccl_frontend', 'yith_wccl_general', array(
				...
				'view_cart'     => esc_attr__( 'View cart', 'yith-woocommerce-advanced-product-options' ),
