...
if ( ! class_exists( 'YITH_WAPO_Frontend' ) ) {
     ...
     */
        ...
        public function __construct( $version ) {
            ...
            $this->_option_loop_add_to_cart_text = get_option( 'yith_wapo_settings_addtocartlabel' ,__( 'Select options' , 'yith-woocommerce-advanced-product-options' ) );
        ...
        public  function enqueue_styles_scripts() {
            ...
            $color_picker_param = array(
                'clear'                                 => __( 'Clear' , 'yith-woocommerce-advanced-product-options' ),
                'defaultString'                         => __( 'Default' , 'yith-woocommerce-advanced-product-options' ),
                'pick'                                  => __( 'Select color' , 'yith-woocommerce-advanced-product-options' ),
                'current'                               => __( 'Current color' , 'yith-woocommerce-advanced-product-options' ),
            ) ;
        ...
        public function printOptions( $key , $product, $type_id ,$type , $name, $value, $price ,$label='',$image='', $price_type='fixed', $description='', $required=false , $checked=false, $disabled='' , $label_position ='before' , $min = false , $max = false  ){
            ...
            $span_label   = sprintf( '<label class="ywapo_label_tag_position_%s">%s<span class="ywapo_option_label ywapo_label_position_%s">%s</span></label>', $label_position , $image_html, $label_position, esc_html( $label ) );
        ...
        public function add_to_cart_text( $text="" ) {
            ...
            if ( is_object( $product )  && ! is_single( $post ) ) {
                ...
                if( in_array( $product->product_type, $product_type_list ) ) {
                    ...
                    if ( !empty( $types_list ) ) {
                        $text = ! empty( $this->_option_loop_add_to_cart_text ) ? $this->_option_loop_add_to_cart_text : __( 'Select options', 'yith-woocommerce-advanced-product-options' );
                    }
