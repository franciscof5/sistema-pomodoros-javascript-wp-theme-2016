<?php
/**
 * Plugin Name: YITH WooCommerce Advanced Product Options Premium
 * Plugin URI: http://yithemes.com/
 * Description: YITH WooCommerce Advanced Product Options .
 * Version: 1.0.6
 * Author: YITHEMES
 * Author URI: http://yithemes.com/
 * Text Domain: yith-woocommerce-advanced-product-options
...
if ( ! function_exists( 'yith_wapo_install_premium_woocommerce_admin_notice' ) ) {
    ...
    function yith_wapo_install_premium_woocommerce_admin_notice() {
        ?>
        <div class="error">
            <p><?php _e( 'YITH WooCommerce Advanced Product Options is enabled but not effective. It requires WooCommerce in order to work.', 'yith-woocommerce-advanced-product-options' ); ?></p>
        </div>
    <?php
    }
}
...
! defined( 'YITH_WAPO_VERSION' ) && define( 'YITH_WAPO_VERSION', '1.0.6' );
! defined( 'YITH_WAPO_DB_VERSION' ) && define( 'YITH_WAPO_DB_VERSION', '1.0.0' );
...
! defined( 'YITH_WAPO_WPML_CONTEXT' ) && define( 'YITH_WAPO_WPML_CONTEXT', 'YITH WooCommerce Advanced Product Options' );
...
function yith_wapo_premium_init() {
    ...
    load_plugin_textdomain( YITH_WAPO_SLUG, false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
