...
add_action( 'tgmpa_register', 'projectimer_plugin_register_required_plugins' );
 ...
 */
function projectimer_plugin_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			'name'      => 'BuddyPress Multi Network',
			'slug'      => 'bp-multi-network',
			'force_activation'   => true,
		),
		
		/*
		array(
			'name'               => 'Projectimer Calendar', // The plugin name.
			'slug'               => 'projectimer-calendar', // The plugin slug (typically the folder name).
			'source'    		 => 'https://github.com/franciscof5/projectimer-calendar/archive/master.zip',
			#'source'             => plugin_dir_path() . '/projectimer-calendar', // The plugin source.
			#'required'           => true, // If false, the plugin is only 'recommended' instead of required.
			#'version'            => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
			'force_activation'   => true, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
			#'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
			#'external_url'       => 'https://github.com/franciscof5/projectimer-calendar/archive/master.zip', // If set, overrides default API URL and points to an external URL.
	 ...
	 */
	$config = array(
		'id'           => 'Projectimer',                 // Unique ID for hashing notices for multiple instances of TGMPA.
