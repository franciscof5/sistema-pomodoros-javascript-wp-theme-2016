<?php
/*
Plugin Name: F5 Sites | Fnetwork WordPress Social Login
...
/**************FNETWORK AUTO INSTALL******************/
//FNETWORK AUTO INSTALL

update_option("wsl_components_buddypress_enabled", 1);
update_option("wsl_components_login-widget_enabled", 1);
update_option("wsl_settings_widget_display", 1);



update_option("wsl_settings_Facebook_app_scope", "email, public_profile, user_friends");
update_option("wsl_settings_Facebook_enabled", 1);
update_option("wsl_settings_Facebook_app_id", "442626267030129");
update_option("wsl_settings_Facebook_app_secret	", "8acf5c3c424a5e50df433ffbe007c462");

update_option("wsl_settings_Google_app_scope", "profile https://www.googleapis.com/auth/plus.profile.emails.read");
update_option("wsl_settings_Google_enabled", 1);
update_option("wsl_settings_Google_app_id", "207228192747-ns9e8mgug6nnqj8dmq9nobr9k7v6rev1.apps.googleusercontent.com");
update_option("wsl_settings_Google_app_secret", "XVPgZbeMROHFx_qEjYvjNlQw");

update_option("wsl_settings_LinkedIn_enabled", 0);
update_option("wsl_settings_LinkedIn_app_id", "77mmbwh9ct92k0");
update_option("wsl_settings_LinkedIn_app_secret	", "GrovJys0QoOlvHrY");
...
$db_table_exists = $wpdb->get_var("SHOW TABLES LIKE '$wslusersprofiles'") == $wslusersprofiles;
