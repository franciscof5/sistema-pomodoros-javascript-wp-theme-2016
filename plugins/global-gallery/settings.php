...
<div class="wrap lcwp_form">  
	...
	if(isset($_POST['lcwp_admin_submit'])) { 
		...
		$indexes[] = array('index'=>'gg_lb_lcl_openclose', 'label'=>'Lightbox openClose effect');
		$indexes[] = array('index'=>'gg_lb_simplelb_style', 'label'=>'SimpleLightbox style');
		...
		$indexes[] = array('index'=>'gg_lb_use_shadow', 'label'=>'Lightbox outer shadow');	
		
		$indexes[] = array('index'=>'gg_lcl_txt_pos', 'label'=>'LC Lightbox text position');
		$indexes[] = array('index'=>'gg_lb_txt_treshold', 'label'=>__( 'Lightbox text visibility treshold', 'gg_ml' ), 'type'=>'int');
		$indexes[] = array('index'=>'gg_lb_cmd_pos', 'label'=>'Lightbox commands position');
		$indexes[] = array('index'=>'gg_lb_corner_close', 'label'=>'Lightbox corner close command');
		$indexes[] = array('index'=>'gg_lb_middle_nav_pos', 'label'=>'Lightbox middle navigation buttons');		
		...
		$indexes[] = array('index'=>'gg_lb_tn_treshold', 'label'=>__( 'Lightbox thumbnails visibility treshold', 'gg_ml' ), 'type'=>'int');
		$indexes[] = array('index'=>'gg_lb_thumb_w', 'label'=>__( 'Lightbox thumbnails Width', 'gg_ml' ), 'type'=>'int');
		$indexes[] = array('index'=>'gg_lb_thumb_h', 'label'=>__( 'Lightbox thumbnails Height', 'gg_ml' ), 'type'=>'int');
		...
		$indexes[] = array('index'=>'gg_lb_fs_treshold', 'label'=>__( 'Lightbox text visibility treshold', 'gg_ml' ), 'type'=>'int');
		
		$indexes[] = array('index'=>'gg_lb_deeplink', 'label'=>'Lightbox - Enable deeplinking system?');
		$indexes[] = array('index'=>'gg_lb_download', 'label'=>'Enable lightbox images download?');
		$indexes[] = array('index'=>'gg_lb_zoom', 'label'=>'Enable images zoom?');
		$indexes[] = array('index'=>'gg_lb_counter', 'label'=>'Enable images counter');
		$indexes[] = array('index'=>'gg_lb_socials', 'label'=>'Enable Socials');
		$indexes[] = array('index'=>'gg_lb_slideshow', 'label'=>'Lightbox slideshow');
		$indexes[] = array('index'=>'gg_lb_progressbar', 'label'=>'Show progressbar?');
		$indexes[] = array('index'=>'gg_lb_oc_time', 'label'=>'Lightbox open/close timing');
		...
		$fdata['gg_lb_lcl_openclose'] = get_option('gg_lb_lcl_openclose', 'lcl_zoomin_oc');
		$fdata['gg_lb_lcl_style'] = get_option('gg_lb_lcl_style', 'minimal');
		$fdata['gg_simplelb_style'] = get_option('gg_simplelb_style', 'minimal');
		...
		$fdata['gg_lb_use_shadow'] = get_option('gg_lb_use_shadow');
		
		$fdata['gg_lcl_txt_pos'] = get_option('gg_lcl_txt_pos');
		$fdata['gg_lb_txt_treshold'] = get_option('gg_lb_txt_treshold', 500);
		$fdata['gg_lb_cmd_pos'] = get_option('gg_lb_cmd_pos');
		$fdata['gg_lb_corner_close'] = get_option('gg_lb_corner_close');
		$fdata['gg_lb_middle_nav_pos'] = get_option('gg_lb_middle_nav_pos');
		$fdata['gg_lb_txt_pos'] = get_option('gg_lb_txt_pos');
		
		$fdata['gg_lb_thumbs'] = get_option('gg_lb_thumbs');
		$fdata['gg_lb_tn_treshold'] = get_option('gg_lb_tn_treshold', 500);
		$fdata['gg_lb_thumb_w'] = get_option('gg_lb_thumb_w', 100);
		$fdata['gg_lb_thumb_h'] = get_option('gg_lb_thumb_h', 100);
		$fdata['gg_lb_thumbs_full_img'] = get_option('gg_lb_thumbs_full_img');
		
		$fdata['gg_lb_fullscreen'] = get_option('gg_lb_fullscreen');
		$fdata['gg_lb_fs_treshold'] = get_option('gg_lb_fs_treshold', 500);
		
		$fdata['gg_lb_deeplink'] = get_option('gg_lb_deeplink');
		$fdata['gg_lb_download'] = get_option('gg_lb_download');
		$fdata['gg_lb_zoom'] = get_option('gg_lb_zoom');
		$fdata['gg_lb_counter'] = get_option('gg_lb_counter');
		$fdata['gg_lb_socials'] = get_option('gg_lb_socials');
		$fdata['gg_lb_slideshow'] = get_option('gg_lb_slideshow');
		$fdata['gg_lb_progressbar'] = get_option('gg_lb_progressbar');
		
		$fdata['gg_lb_oc_time'] = get_option('gg_lb_oc_time', 500);
		$fdata['gg_lb_ss_time'] = get_option('gg_lb_ss_time', 5000);
		$fdata['gg_lb_time'] = get_option('gg_lb_time', 300);
    ...
    <div id="layouts">
        ...
        <table class="widefat lcwp_table">
          <tr>
            ...
            <td><span class="info"><?php _e("Set default columns number for photostring layout", 'gg_ml'); ?></span></td>
          </tr>
          <tr>
            <td class="lcwp_label_td"><?php _e("Images margin", 'gg_ml'); ?></td>
            <td class="lcwp_field_td">
          ...
          <tr>
            ...
            <td class="lcwp_field_td">
                <select data-placeholder="<?php _e("Select an option", 'gg_ml'); ?> .." name="gg_lightbox" id="gg_lightbox" class="lcweb-chosen" autocomplete="off"style="width: 300px;">
                  <option value="lcweb">LC Lightbox</option> 
         ...
         <tr class="lb_opt_lcweb">
            ...
            <td class="lcwp_field_td">
            	<select data-placeholder="<?php _e("Select a style", 'gg_ml'); ?> .." name="gg_lb_lcl_style" class="lcweb-chosen" autocomplete="off">
                  ...
                  <option value="light" <?php if($fdata['gg_lb_lcl_style'] == 'light') {echo 'selected="selected"';} ?>>Light</option>  
                  <option value="dark" <?php if($fdata['gg_lb_lcl_style'] == 'dark') {echo 'selected="selected"';} ?>>Dark</option>
                </select>
            </td>
            <td><span class="info"><?php _e("Select lightbox skin", 'gg_ml'); ?></span></td>
          </tr>
          <tr class="lb_opt_lcweb">
            <td class="lcwp_label_td"><?php _e("Open/close effect", 'gg_ml'); ?></td>
            <td class="lcwp_field_td">
            	<select data-placeholder="<?php _e("Select an option", 'gg_ml'); ?> .." name="gg_lb_lcl_openclose" class="lcweb-chosen" autocomplete="off">
                  <?php
				  foreach(gg_lcl_openclose_list() as $i=>$val) {
					 $sel = ($fdata['gg_lb_lcl_openclose'] == $i) ? 'selected="selected"' : '';
					 echo '<option value="'.$i.'" '.$sel.'>'.$val.'</option>'; 
				  }
				  ?>
                </select>
            </td>
            <td><span class="info"><?php _e("Select which opening/closing effect to use (for custom CSS, classes are <em>.lcl_pre_show</em> and <em>.lcl_is_closing</em>)", 'gg_ml'); ?></span></td>
          </tr>
          <tr class="lb_opt_simplelb">
            <td class="lcwp_label_td"><?php _e("Style", 'gg_ml'); ?></td>
            <td class="lcwp_field_td">
            	<select data-placeholder="<?php _e("Select a style", 'gg_ml'); ?> .." name="gg_simplelb_style" class="lcweb-chosen" autocomplete="off">
                  <option value="light">Light</option>  
                  <option value="dark" <?php if($fdata['gg_simplelb_style'] == 'dark') {echo 'selected="selected"';} ?>>Dark</option>
                </select>
            </td>
            <td><span class="info"><?php _e("Select lightbox skin", 'gg_ml'); ?></span></td>
          </tr>
          ...
          <tr class="lb_opt_lcweb lb_opt_lightcase lb_opt_mag_popup lb_opt_simplelb lb_opt_imagelb">
            ...
            <td class="lcwp_field_td" colspan="2">
				...
				foreach(gg_lcl_patterns_list() as $file => $name) {
					...
					echo '<div class="gg_setting_pattern '.$sel.'" id="ggp_'.$name.'" style="background: url('.GG_URL.'/js/lightboxes/lc-lightbox/img/patterns/'.$file.') repeat top left transparent;"></div>';		
				}
				?>
            </td>
          </tr>
          ...
          <tr class="lb_opt_lcweb">
            <td class="lcwp_label_td"><?php _e("Outer shadow?", 'gg_ml'); ?></td>
            <td class="lcwp_field_td">
            	<?php ($fdata['gg_lb_use_shadow'] == 1) ? $sel = 'checked="checked"' : $sel = ''; ?>
                <input type="checkbox" value="1" name="gg_lb_use_shadow" class="ip-checkbox" <?php echo $sel; ?> />
            </td>
            <td><span class="info"></span></td>
          </tr>
          ...
          <tr class="lb_opt_lcweb">
            ...
            <td class="lcwp_field_td">
            	<select data-placeholder="<?php _e("Select an option", 'gg_ml'); ?> .." name="gg_lcl_txt_pos" class="lcweb-chosen" autocomplete="off">
                  <option value="under"><?php _e("Under image", 'gg_ml'); ?></option>  
                  <option value="over" <?php if($fdata['gg_lcl_txt_pos'] == 'over') {echo 'selected="selected"';} ?>><?php _e("Over image", 'gg_ml'); ?></option>
                  <option value="rside" <?php if($fdata['gg_lcl_txt_pos'] == 'rside') {echo 'selected="selected"';} ?>><?php _e("On right side", 'gg_ml'); ?></option>
                  <option value="lside" <?php if($fdata['gg_lcl_txt_pos'] == 'lside') {echo 'selected="selected"';} ?>><?php _e("On left side", 'gg_ml'); ?></option>
                </select>
            </td>
            <td><span class="info"><?php _e("Select text position in lightbox", 'gg_ml'); ?></span></td>
          </tr>
          <tr class="lb_opt_lcweb">
            <td class="lcwp_label_td"><?php _e("Text visibility treshold", 'gg_ml'); ?></td>
            <td class="lcwp_field_td">
            	<div class="lcwp_slider" step="100" max="2500" min="200"></div>
                <input type="text" value="<?php echo (int)$fdata['gg_lb_txt_treshold']; ?>" name="gg_lb_txt_treshold" class="lcwp_slider_input" />
                <span>px</span>
            </td>
            <td><span class="info"><?php _e("Screens smaller than this value have text hidden by default", 'gg_ml'); ?></span></td>
          </tr>
          
          <tr class="lb_opt_lcweb">
            <td class="lcwp_label_td"><?php _e("Commands position", 'gg_ml'); ?></td>
            <td class="lcwp_field_td">
            	<select data-placeholder="<?php _e("Select an option", 'gg_ml'); ?> .." name="gg_lb_cmd_pos" class="lcweb-chosen" autocomplete="off">
                  <option value="inner"><?php _e("Inner", 'gg_ml'); ?></option>  
                  <option value="outer" <?php if($fdata['gg_lb_cmd_pos'] == 'outer') {echo 'selected="selected"';} ?>><?php _e("Outer", 'gg_ml'); ?></option>
                </select>
            </td>
            <td><span class="info"></span></td>
          </tr>
          <tr class="lb_opt_lcweb">
            <td class="lcwp_label_td"><?php _e("Closing button in corner position?", 'gg_ml'); ?></td>
            <td class="lcwp_field_td">
           		<?php ($fdata['gg_lb_corner_close'] == 1) ? $sel = 'checked="checked"' : $sel = ''; ?>
                <input type="checkbox" value="1" name="gg_lb_corner_close" class="ip-checkbox" <?php echo $sel; ?> />
            </td>
            <td><span class="info"></span></td>
          </tr>
          <tr class="lb_opt_lcweb">
            <td class="lcwp_label_td"><?php _e("Navigation buttons in middle position?", 'gg_ml'); ?></td>
            <td class="lcwp_field_td">
           		<?php ($fdata['gg_lb_middle_nav_pos'] == 1) ? $sel = 'checked="checked"' : $sel = ''; ?>
                <input type="checkbox" value="1" name="gg_lb_middle_nav_pos" class="ip-checkbox" <?php echo $sel; ?> />
            </td>
            <td><span class="info"></span></td>
          </tr>

          <tr class="lb_opt_fancybox">
            <td class="lcwp_label_td"><?php _e("Text position", 'gg_ml'); ?></td>
            <td class="lcwp_field_td">
            	<select data-placeholder="<?php _e("Select an option", 'gg_ml'); ?> .." name="gg_lb_txt_pos" class="lcweb-chosen" autocomplete="off">
          ...
          <tr class="lb_opt_lcweb">
            <td class="lcwp_label_td"><?php _e("Thumbnails visibility treshold", 'gg_ml'); ?></td>
            <td class="lcwp_field_td">
            	<div class="lcwp_slider" step="100" max="2500" min="200"></div>
                <input type="text" value="<?php echo (int)$fdata['gg_lb_tn_treshold']; ?>" name="gg_lb_tn_treshold" class="lcwp_slider_input" />
                <span>px</span>
            </td>
            <td><span class="info"><?php _e("Screens smaller than this value have thumbnails hidden by default", 'gg_ml'); ?></span></td>
          </tr>
          <tr class="lb_opt_lcweb">
            <td class="lcwp_label_td"><?php _e("Thumbnail sizes", 'gg_ml'); ?></td>
            <td class="lcwp_field_td">
                <input type="text" name="gg_lb_thumb_w" value="<?php echo $fdata['gg_lb_thumb_w'] ?>" maxlength="3" class="lcwp_slider_input" /> x 
            	<input type="text" name="gg_lb_thumb_h" value="<?php echo $fdata['gg_lb_thumb_h'] ?>" maxlength="3" class="lcwp_slider_input" />
                <span>px</span>
            </td>
            <td><span class="info"><?php _e("Set lightbox thumbnail sizes", 'gg_ml'); ?></span></td>
          </tr>
          <tr class="lb_opt_lcweb">
            ...
            <td><span class="info"><?php _e("If checked, fills thumbnails with full-size images (<strong>use ONLY if you note thumbs loading issues</strong>)", 'gg_ml'); ?></span></td>
          </tr>
          ...
          <tr class="lb_opt_lcweb">
            <td class="lcwp_label_td"><?php _e("Fullscreen treshold", 'gg_ml'); ?></td>
            <td class="lcwp_field_td">
            	<div class="lcwp_slider" step="100" max="2500" min="200"></div>
                <input type="text" value="<?php echo (int)$fdata['gg_lb_fs_treshold']; ?>" name="gg_lb_fs_treshold" class="lcwp_slider_input" />
                <span>px</span>
            </td>
            <td><span class="info"><?php _e("Lightbox will be only in fullscreen mode for screens smaller than this value", 'gg_ml'); ?></span></td>
          </tr>
          
          <tr class="lb_opt_lcweb">
            <td class="lcwp_label_td"><?php _e("Enable deeplink?", 'gg_ml'); ?></td>
            <td class="lcwp_field_td">
           		<?php ($fdata['gg_lb_deeplink'] == 1) ? $sel = 'checked="checked"' : $sel = ''; ?>
                <input type="checkbox" value="1" name="gg_lb_deeplink" class="ip-checkbox" <?php echo $sel; ?> />
            </td>
            <td><span class="info"><?php _e("If checked, enables images deeplinking", 'gg_ml'); ?></span></td>
          </tr>
          <tr class="lb_opt_lcweb">
            <td class="lcwp_label_td"><?php _e("Download button?", 'gg_ml'); ?></td>
            <td class="lcwp_field_td">
           		<?php ($fdata['gg_lb_download'] == 1) ? $sel = 'checked="checked"' : $sel = ''; ?>
                <input type="checkbox" value="1" name="gg_lb_download" class="ip-checkbox" <?php echo $sel; ?> />
            </td>
            <td><span class="info"><?php _e("If checked, enables images download button (only for self hosted images)", 'gg_ml'); ?></span></td>
          </tr>
          <tr class="lb_opt_lcweb">
            <td class="lcwp_label_td"><?php _e("Enable zoom?", 'gg_ml'); ?></td>
            <td class="lcwp_field_td">
           		<?php ($fdata['gg_lb_zoom'] == 1) ? $sel = 'checked="checked"' : $sel = ''; ?>
                <input type="checkbox" value="1" name="gg_lb_zoom" class="ip-checkbox" <?php echo $sel; ?> />
            </td>
            <td><span class="info"><?php _e("If checked, enables images zooming system", 'gg_ml'); ?></span></td>
          </tr>
          <tr class="lb_opt_lcweb">
            <td class="lcwp_label_td"><?php _e("Show counter?", 'gg_ml'); ?></td>
            <td class="lcwp_field_td">
           		<?php ($fdata['gg_lb_counter'] == 1) ? $sel = 'checked="checked"' : $sel = ''; ?>
                <input type="checkbox" value="1" name="gg_lb_counter" class="ip-checkbox" <?php echo $sel; ?> />
            </td>
            <td><span class="info"><?php _e("If checked, displays images count and progress", 'gg_ml'); ?></span></td>
          </tr>
          ...
          <tr class="lb_opt_lcweb">
            <td class="lcwp_label_td"><?php _e("Show progressbar?", 'gg_ml'); ?></td>
            <td class="lcwp_field_td">
           		<?php ($fdata['gg_lb_progressbar'] == 1) ? $sel = 'checked="checked"' : $sel = ''; ?>
                <input type="checkbox" value="1" name="gg_lb_progressbar" class="ip-checkbox" <?php echo $sel; ?> />
            </td>
            <td><span class="info"><?php _e("If checked, shows a progressbar during slideshow", 'gg_ml'); ?></span></td>
          </tr>
          
          <tr class="lb_opt_lcweb">
            <td class="lcwp_label_td"><?php _e("Open / Close timing", 'gg_ml'); ?></td>
            <td class="lcwp_field_td">
            	<div class="lcwp_slider" step="50" max="2000" min="0"></div>
                <input type="text" value="<?php echo (int)$fdata['gg_lb_oc_time']; ?>" name="gg_lb_oc_time" class="lcwp_slider_input" />
                <span>ms</span>
            </td>
            <td><span class="info"><?php _e("Set open/close lightbox timing (default 500)", 'gg_ml'); ?></span></td>
          </tr>
          <tr class="lb_opt_lcweb lb_opt_lightcase lb_opt_colorbox lb_opt_prettyphoto  lb_opt_photobox">
            <td class="lcwp_label_td"><?php _e("Slideshow interval", 'gg_ml'); ?></td>
            <td class="lcwp_field_td">
