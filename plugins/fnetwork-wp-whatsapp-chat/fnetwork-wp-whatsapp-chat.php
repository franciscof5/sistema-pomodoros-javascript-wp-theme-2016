...
<a href="https://<?php if (wp_is_mobile() ) {echo "api";} else {echo "web";}?>.whatsapp.com/send?phone=+557399728692&text=Ola, vim pelo site <?php $_SERVER['SERVER_NAME'] ?>." onclick="gtag('event', 'WhatsApp', {'event_action': 'whatsapp_chat', 'event_category': 'Chat', 'event_label': 'Chat_WhatsApp'});" target="_blank"><?php echo esc_attr( get_option('whatsapp_chat_button')); ?><img src="<?php echo plugins_url('/images/whatsapp.svg', __FILE__); ?>	" alt="WhatsApp"></a>
</div>
<?php }//hide_button ?>
<?php
}
