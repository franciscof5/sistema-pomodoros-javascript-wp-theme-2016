...
class Tribe__Tickets_Plus__Meta {
	...
	public function tickets_post_capacity( $post_id ) {
		_deprecated_function( __METHOD__, 'TBD', "tribe( 'tickets-plus.admin.views' )->template( 'editor/button-view-orders' )" );
	...
	public function tickets_new_ticket_button() {
		_deprecated_function( __METHOD__, 'TBD', "tribe( 'tickets-plus.admin.views' )->template( 'button-new-ticket' )" );
	...
	public function ticket_table_add_tbody_column( $ticket, $provider_obj ) {
		_deprecated_function( __METHOD__, 'TBD', "tribe( 'tickets-plus.editor' )->add_column_content_price( \$ticket, \$provider_obj )" );
	...
	public function ticket_table_add_header_column() {
		_deprecated_function( __METHOD__, 'TBD', "tribe( 'tickets-plus.admin.views' )->template( 'editor/column-head-price' )" );
	...
	public function tickets_settings_capacity_table( $post_id ) {
		_deprecated_function( __METHOD__, 'TBD', "tribe( 'tickets-plus.admin.views' )->template( 'editor/capacity-table' )" );
	...
	public function display_tickets_capacity( $post_id ) {
		_deprecated_function( __METHOD__, 'TBD', "tribe( 'tickets-plus.admin.views' )->template( 'editor/total-capacity' )" );
	...
	public function tickets_settings_content( $post_id ) {
		_deprecated_function( __METHOD__, 'TBD', "tribe( 'tickets-plus.admin.views' )->template( 'editor/price-field' )" );
