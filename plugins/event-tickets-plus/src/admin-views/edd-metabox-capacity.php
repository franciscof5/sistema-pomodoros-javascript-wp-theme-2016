	...
	>
			...
			>
				<?php if ( ! $has_event_capacity ) : ?>
					<div class="global_capacity-wrapper">
						...
						<input
							...
							class="ticket_field tribe-ticket-field-event-capacity"
				...
				<div>
					...
					<input
						...
						class="ticket_field tribe-ticket-field-capacity"
						size="7"
		...
		<div class="input_block">
			<label for="<?php echo $provider; ?>_own" class="ticket_field">
				...
				<span class="dashicons dashicons-editor-help" title="<?php esc_attr_e( 'Set capacity for this ticket only', 'event-tickets-plus' ); ?>"></span>
			</label>
			<div
...
if ( apply_filters( 'tribe_tickets_default_purchase_limit', 0 ) ) {
	...
	<div class="<?php $this->tr_class(); ?>">
		<div><label for="<?php echo $provider; ?>_ticket_purchase_limit"><?php esc_html_e( 'Purchase limit:', 'event-tickets-plus' ); ?></label></div>
		<div>
			<input type="text" id="<?php echo $provider; ?>_ticket_purchase_limit" name="ticket_purchase_limit" class="ticket_field" size="7" data-default-value="<?php echo esc_attr( $purchase_limit ); ?>"/>
		</div>
	</div>
	<?php
}
