  ...
  <div class="wcfm-page-headig">
	...
	<div class="wcfm-collapse-content">
		...
		<div class="wcfm-container wcfm-top-element-container">
			...
			if( $article_id ) {
				?>
				<span class="article-status article-status-<?php echo $wcfm_articles_single->post_status; ?>"><?php if( $wcfm_articles_single->post_status == 'publish' ) { _e( 'Published', 'wc-frontend-manager' ); } else { echo ucfirst( $wcfm_articles_single->post_status ); } ?></span>
				<?php
				if( $wcfm_articles_single->post_status == 'publish' ) {
