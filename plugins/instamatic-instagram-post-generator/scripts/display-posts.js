...
registerBlockType( 'instamatic-instagram-post-generator/instamatic-display', {
    title: 'Instamatic Display Posts',
    icon: 'instagram',
    category: 'embed',
    attributes: {
        ruletype : {
    ...
    keywords: ['display', 'posts', 'instamatic'],
    edit: (function( props ) {
