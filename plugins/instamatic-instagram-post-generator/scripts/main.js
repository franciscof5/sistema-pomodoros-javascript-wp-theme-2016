...
var initial = '';
    function mainChanged()
    {
        ...
        if(jQuery('#links_hide_google').is(":checked") || jQuery('#links_hide_google2').is(":checked"))
        {            
            jQuery(".hideGoogl").show();
        }
        else
        {
            jQuery(".hideGoogl").hide();
        } 
...
else
{
    ...
    jQuery(document).ready(function(){
					jQuery('span.wpinstamatic-delete').on('click', function(){
